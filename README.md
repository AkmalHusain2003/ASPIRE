...
2. **Geometric Conversion** — Geometric transformations project the 3D N-body simulation output onto the sky plane, converting positions into a transit light curve.
